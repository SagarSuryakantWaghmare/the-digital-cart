...
import heroImg from "../../assets/Daily.jpg";
import { Link } from 'react-router-dom';
const Hero = () => {
  return (
    <section className='relative'>
        <img src={heroImg} alt="hero Image"
        className='w-full brightness-75 h-[400px] md:h-[600px] lg:h-[750px]
        object-cover' />
        ...
        '>
         <div className='text-center text-white p-6'>
            ...
            <p className='text-sm tracking-tighter md:text-lg mb-6'>
                Explore our vaction-ready outfits with fast worldwide shopping.
            </p>
